...
| 6   | Extra Tools                                    | Need C/C++ compiler and `tree-sitter` cli for C parsers to load dynamic library (`so`, `dll`), no extra tools for WASM parsers (but rarely supported) | No                                                                                                                                                                                                         | No                                                                                                |
