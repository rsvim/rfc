...
| 2   | Performance (especially on opening a new file) | Lowest                                                                                                                                                                 | Fine                                                                                                                                                                                                       | Highest                                                                                           |
...
| 6   | Extra Tools                                    | Need C/C++ compiler and `tree-sitter` cli for C parsers to load dynamic library (`so`, `dll`), no extra tools for WASM parsers (but WASM parsers are rarely supported) | No                                                                                                                                                                                                         | No                                                                                                |
