...
| 6   | Extra Tools                                    | C/C++ compiler and `tree-sitter` cli for C parsers to load dynamic library (`so`, `dll`), no extra tools needed for WASM parsers (but rarely supported) | No                                                                                                                                                                                                         | No                                                                                                |
