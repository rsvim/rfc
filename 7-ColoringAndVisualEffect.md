...
Coloring and visual effect system makes a text editor colorful. Except relying on a [syntax parser](6-Syntax.md), it also contains multiple components to provide a good user experience:

1. A syntax parser recognizes text semantics and parses into tokens for programming languages and structured text content.
