...
Coloring and visual effect system is the most important and easiest obvious at a glance for users. In this section we will use coloring system as a use case to describe what syntax parser we need in Rsvim.
