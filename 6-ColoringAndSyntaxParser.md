...
| Development Effort                             | [tree-sitter](https://crates.io/crates/tree-sitter) | [syntect](https://crates.io/crates/syntect) works with `.sublime-syntax` and `.tmLanguage` configuration files                                                                                             | N/A                                                                                               |
