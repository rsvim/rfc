...
| Loading Syntax Configurations                  | Need C/C++ compiler and `tree-sitter` cli for C-parsers to load dynamic library (`so`, `dll`), no extra tools for WASM-parsers | No extra tools                                                                                                                                                                                             | No extra tools                                                                                    |
