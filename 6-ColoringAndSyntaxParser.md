...
| 5   | Syntax Configurations                          | Active Community                                                                                                                                           | `.sublime-syntax` collections in [sublime-text packages](https://github.com/sublimehq/Packages), `.tmLanguage` collections in [github linguist](https://github.com/github-linguist/linguist/tree/main/vendor/grammars) | `.vim` collections in [vim runtime/syntax](https://github.com/vim/vim/tree/master/runtime/syntax)                |
...
| TextMate          | - Good performance                               | - Syntax configurations are not actively maintained<br>- <br>- `.sublime-syntax` files can have a **branding** issue (feel bad to use another editor's resource)<br>- Low-quality results should work fine for coloring system, however as more features depend on the parser results, it can lead to worse and buggy experiences |
