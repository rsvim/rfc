...
- Different languages and grammar implementations can have [huge performance differences](https://owen.cafe/posts/tree-sitter-haskell-perf/). Since they are maintained by different communities, which we cannot rely on.
