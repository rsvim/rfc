...
| 5   | Syntax Configurations                          | Active Community                                                                                                                                           | `.sublime-syntax` collections in [sublime-text packages](https://github.com/sublimehq/Packages)                | `.vim` collections in [vim runtime/syntax](https://github.com/vim/vim/tree/master/runtime/syntax)                |
