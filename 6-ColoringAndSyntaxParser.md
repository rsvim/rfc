...
> NOTE: We don't count [language-server-protocol](https://microsoft.github.io/language-server-protocol/) as syntax parser, it is a big improvement but not mandatory.
...
| TextMate          |                                                  | - Syntax configurations are not actively maintained<br>- `.sublime-syntax` files can have a **branding** issue (feel bad to use another editor's resource)<br>- Low-quality results should work fine for coloring system, however as more features depend on the parser results, it can lead to worse and buggy experiences |
| Vim Syntax Engine |                                                  | - Need to implement from scratch<br>- Same impact with TextMate on low-quality results                                                                                                                                                                                                                                      |
